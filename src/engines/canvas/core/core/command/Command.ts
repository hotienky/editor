...
export class Command {
  ...
  public executeSetGutter: CommandAdapt['setGutter']
  ...
  public exportJson: CommandAdapt['exportJson']
  public exportJsonAsync: CommandAdapt['exportJsonAsync']
  public importJson: CommandAdapt['importJson']
  public importGoogleDocs: CommandAdapt['importGoogleDocs']
  public getGoogleDocs: CommandAdapt['getGoogleDocs']
  public exportGoogleDocs: CommandAdapt['exportGoogleDocs']
  public importDocx: CommandAdapt['importDocx']
  public exportDocx: CommandAdapt['exportDocx']
  public getDocx: CommandAdapt['getDocx']
  public executeExportJson: CommandAdapt['exportJson']
  public executeExportJsonAsync: CommandAdapt['exportJsonAsync']
  public executeImportJson: CommandAdapt['importJson']
  public executeImportGoogleDocs: CommandAdapt['importGoogleDocs']
  public executeExportGoogleDocs: CommandAdapt['exportGoogleDocs']
  public executeImportDocx: CommandAdapt['importDocx']
  ...
  public getGutter: CommandAdapt['getGutter']
  ...
  constructor(adapt: CommandAdapt) {
    ...
    this.executeSetGutter = this.wrap(
      'executeSetGutter',
      adapt.setGutter.bind(adapt)
    )
    // 签章
    ...
    this.exportJson = adapt.exportJson.bind(adapt)
    this.exportJsonAsync = adapt.exportJsonAsync.bind(adapt)
    this.importJson = this.wrap('importJson', adapt.importJson.bind(adapt))
    this.importGoogleDocs = this.wrap(
      'importGoogleDocs',
      adapt.importGoogleDocs.bind(adapt)
    )
    this.getGoogleDocs = adapt.getGoogleDocs.bind(adapt)
    this.exportGoogleDocs = adapt.exportGoogleDocs.bind(adapt)
    this.importDocx = this.wrap('importDocx', adapt.importDocx.bind(adapt))
    this.exportDocx = adapt.exportDocx.bind(adapt)
    this.getDocx = adapt.getDocx.bind(adapt)
    this.executeExportJson = adapt.exportJson.bind(adapt)
    this.executeExportJsonAsync = adapt.exportJsonAsync.bind(adapt)
    this.executeImportJson = this.wrap(
      'executeImportJson',
      adapt.importJson.bind(adapt)
    )
    this.executeImportGoogleDocs = this.wrap(
      'executeImportGoogleDocs',
      adapt.importGoogleDocs.bind(adapt)
    )
    this.executeExportGoogleDocs = adapt.exportGoogleDocs.bind(adapt)
    this.executeImportDocx = this.wrap(
      'executeImportDocx',
      adapt.importDocx.bind(adapt)
    )
    ...
    this.getGutter = adapt.getGutter.bind(adapt)
