<template>
  <menus-button
    ...
    menu-type="dropdown"
    huge
    overlay-class-name="kindy-image-dropdown"
  >
    <template #dropmenu>
      <t-dropdown-menu>
        <t-dropdown-item
        ...
        >
          <icon :name="item.icon" class="kindy-image-dropdown-icon" />
          <div>
            <div class="kindy-image-dropdown-title">{{ item.title }}</div>
            <div class="kindy-image-dropdown-description">
              {{ item.description }}
            </div>
          </div>
        </t-dropdown-item>
