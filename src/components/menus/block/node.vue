<template>
  <t-dropdown
    ...
    overlay-class-name="kindy-block-menu-dropdown"
    :max-height="320"
    trigger="click"
  ...
  >
    <menus-button
      class="kindy-block-menu-button"
      :menu-active="menuActive"
      ico="block-add"
      hide-text
    />
    <t-dropdown-menu>
      <t-dropdown-item class="kindy-block-menu-group-name" disabled>
        {{ t('blockMenu.insert') }}
      </t-dropdown-item>
      <t-dropdown-item>
        <menus-button
      ...
      <t-dropdown-item v-if="!disableMenu('stamp')">
        <menus-toolbar-tools-stamp :huge="false" :tooltip="false" />
      </t-dropdown-item>
      ...
      <t-dropdown-item v-if="options.templates.length > 0">
        ...
        >
          ...
          >
            <div class="kindy-dropdown-item-label">{{ item.title }}</div>
          </t-dropdown-item>
        </t-dropdown-menu>
      </t-dropdown-item>
    </t-dropdown-menu>
