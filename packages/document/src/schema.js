...
export const NodeTypes = {
  ...
  doc: {
    name: 'doc',
    group: NodeGroup.TOP,
    content: 'heading? (block | sectionBreak)+ footnotes?',
    topNode: true,
  },
  ...
  sectionBreak: {
    ...
    attributes: {
      ...
      pageSize: { default: null }, // { width, height } or null (inherit)
      pageFormat: { default: null }, // 'a4', 'letter', etc. or null (inherit)
      // Page orientation
      orientation: { default: null }, // 'portrait', 'landscape', or null (inherit)
      // Margins
      ...
      // Header/Footer
      headerEnable: { default: null },
      headerContent: { default: null },
      headerAlign: { default: null },
      footerEnable: { default: null },
      footerContent: { default: null },
      footerAlign: { default: null },
      // Page numbering
      pageNumberStart: { default: null },
      pageNumberFormat: { default: null }, // 'arabic', 'roman_lower', etc.
      pageNumberRestart: { default: false },
      // Column layout
      columns: { default: null },
      columnGap: { default: null },
      // Section label (for TOC, cross-references)
      label: { default: null },
    },
  },
