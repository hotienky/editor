# Kindy Editor v2 documentation

Tài liệu chính của SDK:

1. [Getting started](./getting-started.md)
2. [UI engine](./ui-engine.md)
3. [API reference](./api-reference.md)
4. [Backend integration, security và adapter](../GUIDE.md)
5. [DOCX compatibility matrix](../CAPABILITIES.md)
6. [Performance và tài liệu dài](./performance.md)
7. [Migration v1 → v2](../MIGRATION.md)
8. [REST OpenAPI](../openapi/document-api.yaml)
9. [Completion roadmap và release gates](./completion-roadmap.md)
