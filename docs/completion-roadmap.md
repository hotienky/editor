...
| DOCX body text/style/list/table/image/page break/page setup | Done trong profile v2.0 | Golden/unit test; DOCX đã mở và convert PDF bằng LibreOffice headless không yêu cầu repair |
...
| Comment DOCX round-trip | Done v2.1 codec/editor | Range, reply, resolved và strict round-trip pass |
| Track Changes DOCX round-trip | Done v2.1 codec/editor | Insert/delete/replace transaction, author/time, accept/reject, undo/redo, table text pass |
...
- Golden DOCX mở được bằng LibreOffice headless không yêu cầu repair. **Done** trên Debian/LibreOffice 7.4.7 ARM64 và chạy lại trong CI.
